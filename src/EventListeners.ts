...
import { exportSynergism, updateSaveString, promocodes, promocodesPrompt, promocodesInfo, importSynergism, resetGame, reloadDeleteGame, importData, addCodeAvailableUses, importDataFromTextPrompt } from './ImportExport'
...
export const generateEventHandlers = () => {
  ...
  DOMCacheGetOrSet('importtext').addEventListener('click', () => importDataFromTextPrompt())
